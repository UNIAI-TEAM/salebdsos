...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "NFC Platform — Sales Growth cho Bất động sản" },
      { name: "description", content: "Nền tảng tăng trưởng kinh doanh BĐS — NFC, QR động, Wallet Card, AI Follow-up & CRM." },
      { name: "author", content: "NFC Platform" },
      { property: "og:title", content: "NFC Platform — Sales Growth cho BĐS" },
      { property: "og:description", content: "AI-powered Sales Infrastructure cho chuyên viên & doanh nghiệp BĐS." },
